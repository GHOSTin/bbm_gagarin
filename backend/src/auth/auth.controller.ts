import { Body, Controller, Post, HttpCode, Request, UseGuards, Res } from '@nestjs/common';
...
export class AuthController {
  ...
  refreshTokens(@Request() req) {
    ...
    return this.authService.refreshTokens(userId, refreshToken, { accessOnly: true});
  }
}
